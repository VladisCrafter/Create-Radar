...
package com.happysg.radar.math3.optimization.univariate;

import com.happysg.radar.math3.analysis.UnivariateFunction;
import com.happysg.radar.math3.optimization.BaseOptimizer;
...
public interface BaseUnivariateOptimizer<FUNC extends UnivariateFunction>
     ...
     * @throws com.happysg.radar.math3.exception.ConvergenceException
     ...
     * @throws com.happysg.radar.math3.exception.TooManyEvaluationsException
     * if the maximum evaluation count is exceeded.
     * @throws com.happysg.radar.math3.exception.ConvergenceException if the
     * optimizer detects a convergence problem.
     * @throws IllegalArgumentException if {@code min > max} or the endpoints
     * do not satisfy the requirements specified by the optimizer.
     * @throws com.happysg.radar.math3.exception.NullArgumentException if any
