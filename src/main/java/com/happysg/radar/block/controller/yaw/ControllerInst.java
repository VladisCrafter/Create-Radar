...
public enum ControllerInst {
    ...
    ControllerInst(String parameterName, AllGuiTextures background) {
        this(parameterName, background, false, false, -1, -1, -1);
    }

    ControllerInst(String parameterName, AllGuiTextures background, boolean hasValueParameter,
    ...
    static List<Component> getOptions() {
        ...
        for (ControllerInst entry : values())
